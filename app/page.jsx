    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter text-center mb-12">
            Powerfull Features For Your Career Growth</h2>
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg">
          ...
          md:text-5xl">
            Ready To Give Your Career A Sky Jump ?</h2>
          <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">
            Join Lakhs Of Professionals Who Are Advancing Their Careers With AI-Powered Guidance
            </p>  
           <Link href="/dashboard" passHref>
              ...
              >
                Start Your Journey Right Now <ArrowRight className="ml-2 h-4 w-4"/>
              </Button>
           </Link> 
            </div>
        </div>
